...
export const dictionaries = {
  es: {
    ...
    results: {
      ...
      // Pie de cada archivo del visor. `{a}` y `{b}` se sustituyen por los
      // nombres de las dos variables del protocolo, así que la descripción habla
      // del par que el usuario declaró y no de un dominio fijo. Las claves son
      // el nombre del archivo sin extensión, tal como lo escribe el pipeline.
      fileDescriptions: {
        articles: "Corpus procesado, metadatos extraídos y estado de extracción de texto.",
        mentions: "Menciones auditables de {a} y {b} con sección, frase y contexto.",
        entity_summaries: "Resumen por artículo y entidad, con rol, confianza y evidencia textual.",
        relations: "Relaciones {a}–{b} sustentadas por proximidad textual.",
        systematic_review_table: "Tabla consolidada para revisión sistemática y auditoría manual.",
        heatmap_asociaciones: "Matriz de categorías de {a} frente a categorías de {b}.",
        tipo_estudio: "Distribución del corpus por tipo de estudio inferido.",
        nivel_asociacion: "Conteo de relaciones por nivel de asociación textual.",
        association_network: "Red exploratoria de pares {a}–{b} reportados.",
        top_association_pairs: "Pares de asociación más frecuentes con evidencia cercana.",
        category_association_heatmap: "Heatmap avanzado por categorías de {a} y {b}.",
        association_by_section: "Relaciones distribuidas por sección del artículo.",
        cluster_sizes: "Tamaños de clusters del análisis exploratorio K-Means.",
        kmeans_cluster_map: "Mapa K-Means para triaje exploratorio de artículos.",
        ...
        reporte_revision_nexo: "Reporte Word con resumen ejecutivo, método y referencias a figuras."
      },
      fileDescriptionFallback: "Archivo generado por el pipeline de minería y visualización.",
      fileDescriptionFrequency: "Frecuencia de detección de {v} en el corpus.",
      fileDescriptionBubble: "Burbujas de pares {a}–{b} por frecuencia y peso.",
      fileDescriptionVariableGeneric: "la variable",
      variableAFallback: "variable A",
      variableBFallback: "variable B",
    ...
    execute: {
      ...
      stepValidateDetail: "Revisa la carpeta, los archivos legibles y la ruta de salida.",
      stepPipelineDetail: "Ejecuta el pipeline publicable de review_miner.",
      stepReportDetail: "Crea un documento con resumen, método y referencias a figuras.",
      stepPackageDetail: "Comprime tablas, figuras, JSON y reporte.",
  ...
  en: {
    ...
    results: {
      ...
      // Caption under each file in the viewer. `{a}` and `{b}` are replaced with
      // the protocol's two variable names, so the caption describes the pair the
      // user declared rather than a fixed domain. Keys are the file stem exactly
      // as the pipeline writes it.
      fileDescriptions: {
        articles: "Processed corpus, extracted metadata and text-extraction status.",
        mentions: "Auditable mentions of {a} and {b} with section, sentence and context.",
        entity_summaries: "Per-article, per-entity summary with role, confidence and textual evidence.",
        relations: "{a}–{b} relations backed by textual proximity.",
        systematic_review_table: "Consolidated table for systematic review and manual audit.",
        heatmap_asociaciones: "Matrix of {a} categories against {b} categories.",
        tipo_estudio: "Corpus distribution by inferred study type.",
        nivel_asociacion: "Relation counts by level of textual association.",
        association_network: "Exploratory network of reported {a}–{b} pairs.",
        top_association_pairs: "Most frequent association pairs with nearby evidence.",
        category_association_heatmap: "Advanced heatmap by {a} and {b} categories.",
        association_by_section: "Relations distributed across article sections.",
        cluster_sizes: "Cluster sizes from the exploratory K-Means analysis.",
        kmeans_cluster_map: "K-Means map for exploratory article triage.",
        publication_pipeline_tables: "Excel workbook with the publishable pipeline's extended tables.",
        review_miner_results: "Main pipeline results in Excel or JSON format.",
        reporte_revision_nexo: "Word report with executive summary, method and figure references."
      },
      fileDescriptionFallback: "File generated by the mining and visualisation pipeline.",
      fileDescriptionFrequency: "Detection frequency of {v} across the corpus.",
      fileDescriptionBubble: "Bubbles of {a}–{b} pairs by frequency and weight.",
      fileDescriptionVariableGeneric: "the variable",
      variableAFallback: "variable A",
      variableBFallback: "variable B",
      variableALabel: "Variable A:",
      variableBLabel: "Variable B:",
    ...
    execute: {
      ...
      stepValidateDetail: "Checks the folder, the readable files and the output path.",
      stepPipelineDetail: "Runs the publishable review_miner pipeline.",
      stepReportDetail: "Builds a document with summary, method and figure references.",
      stepPackageDetail: "Zips tables, figures, JSON and report.",
